---
name: quant-real-factor-10d-stability-scaled-range-ratio
description: Use when computing the 10D Stability Scaled Range Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Range Ratio

Use this Skill to compute `10日稳定度缩放振幅占比` / `10D Stability Scaled Range Ratio` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-volume-confirmed-range-ratio
description: Use when computing the 5D Volume Confirmed Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Range Ratio

Use this Skill to compute `5日量能确认振幅占比` / `5D Volume Confirmed Range Ratio` from caller-provided OHLCV data.

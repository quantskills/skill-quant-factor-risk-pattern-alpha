---
name: quant-real-factor-10d-volatility-scaled-stochastic-position
description: Use when computing the 10D Volatility Scaled Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Stochastic Position

Use this Skill to compute `10日波动缩放随机区间位置` / `10D Volatility Scaled Stochastic Position` from caller-provided OHLCV data.

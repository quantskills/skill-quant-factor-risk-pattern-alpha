---
name: quant-real-factor-7d-smoothed-drawdown-from-high
description: Use when computing the 7D Smoothed Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Drawdown From High

Use this Skill to compute `7日平滑距高点回撤` / `7D Smoothed Drawdown From High` from caller-provided OHLCV data.

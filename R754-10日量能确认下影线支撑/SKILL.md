---
name: quant-real-factor-10d-volume-confirmed-lower-wick-support
description: Use when computing the 10D Volume Confirmed Lower Wick Support factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Lower Wick Support

Use this Skill to compute `10日量能确认下影线支撑` / `10D Volume Confirmed Lower Wick Support` from caller-provided OHLCV data.

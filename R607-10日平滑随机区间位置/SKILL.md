---
name: quant-real-factor-10d-smoothed-stochastic-position
description: Use when computing the 10D Smoothed Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Stochastic Position

Use this Skill to compute `10日平滑随机区间位置` / `10D Smoothed Stochastic Position` from caller-provided OHLCV data.

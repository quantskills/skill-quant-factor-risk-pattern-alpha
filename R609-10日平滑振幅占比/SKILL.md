---
name: quant-real-factor-10d-smoothed-range-ratio
description: Use when computing the 10D Smoothed Range Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Range Ratio

Use this Skill to compute `10日平滑振幅占比` / `10D Smoothed Range Ratio` from caller-provided OHLCV data.

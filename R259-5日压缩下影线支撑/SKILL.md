---
name: quant-real-factor-5d-compressed-lower-wick-support
description: Use when computing the 5D Compressed Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Lower Wick Support

Use this Skill to compute `5日压缩下影线支撑` / `5D Compressed Lower Wick Support` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-compressed-intraday-return
description: Use when computing the 10D Compressed Intraday Return factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Intraday Return

Use this Skill to compute `10日压缩日内收益` / `10D Compressed Intraday Return` from caller-provided OHLCV data.

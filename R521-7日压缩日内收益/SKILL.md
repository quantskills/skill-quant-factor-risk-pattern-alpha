---
name: quant-real-factor-7d-compressed-intraday-return
description: Use when computing the 7D Compressed Intraday Return factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Intraday Return

Use this Skill to compute `7日压缩日内收益` / `7D Compressed Intraday Return` from caller-provided OHLCV data.

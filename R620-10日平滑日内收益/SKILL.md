---
name: quant-real-factor-10d-smoothed-intraday-return
description: Use when computing the 10D Smoothed Intraday Return factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Intraday Return

Use this Skill to compute `10日平滑日内收益` / `10D Smoothed Intraday Return` from caller-provided OHLCV data.

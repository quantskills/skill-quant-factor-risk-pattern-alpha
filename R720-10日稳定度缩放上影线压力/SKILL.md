---
name: quant-real-factor-10d-stability-scaled-upper-wick-pressure
description: Use when computing the 10D Stability Scaled Upper Wick Pressure factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Upper Wick Pressure

Use this Skill to compute `10日稳定度缩放上影线压力` / `10D Stability Scaled Upper Wick Pressure` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-stability-scaled-rsi-reversal
description: Use when computing the 5D Stability Scaled RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled RSI Reversal

Use this Skill to compute `5日稳定度缩放RSI反转` / `5D Stability Scaled RSI Reversal` from caller-provided OHLCV data.

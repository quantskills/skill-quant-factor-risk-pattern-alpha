---
name: quant-real-factor-5d-smoothed-intraday-return
description: Use when computing the 5D Smoothed Intraday Return factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Intraday Return

Use this Skill to compute `5日平滑日内收益` / `5D Smoothed Intraday Return` from caller-provided OHLCV data.

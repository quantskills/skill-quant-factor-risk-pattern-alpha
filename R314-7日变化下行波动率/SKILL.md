---
name: quant-real-factor-7d-delta-downside-volatility
description: Use when computing the 7D Delta Downside Volatility factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Downside Volatility

Use this Skill to compute `7日变化下行波动率` / `7D Delta Downside Volatility` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-smoothed-stochastic-position
description: Use when computing the 7D Smoothed Stochastic Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Stochastic Position

Use this Skill to compute `7日平滑随机区间位置` / `7D Smoothed Stochastic Position` from caller-provided OHLCV data.

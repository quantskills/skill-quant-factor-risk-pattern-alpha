---
name: quant-real-factor-10d-delta-range-ratio
description: Use when computing the 10D Delta Range Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Range Ratio

Use this Skill to compute `10日变化振幅占比` / `10D Delta Range Ratio` from caller-provided OHLCV data.

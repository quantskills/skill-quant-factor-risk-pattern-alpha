---
name: quant-real-factor-10d-compressed-rsi-reversal
description: Use when computing the 10D Compressed RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed RSI Reversal

Use this Skill to compute `10日压缩RSI反转` / `10D Compressed RSI Reversal` from caller-provided OHLCV data.

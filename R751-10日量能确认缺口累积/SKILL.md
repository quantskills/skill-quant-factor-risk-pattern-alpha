---
name: quant-real-factor-10d-volume-confirmed-gap-sum
description: Use when computing the 10D Volume Confirmed Gap Sum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Gap Sum

Use this Skill to compute `10日量能确认缺口累积` / `10D Volume Confirmed Gap Sum` from caller-provided OHLCV data.

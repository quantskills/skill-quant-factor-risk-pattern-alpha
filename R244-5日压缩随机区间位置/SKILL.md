---
name: quant-real-factor-5d-compressed-stochastic-position
description: Use when computing the 5D Compressed Stochastic Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Stochastic Position

Use this Skill to compute `5日压缩随机区间位置` / `5D Compressed Stochastic Position` from caller-provided OHLCV data.

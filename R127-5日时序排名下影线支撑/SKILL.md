---
name: quant-real-factor-5d-time-series-ranked-lower-wick-support
description: Use when computing the 5D Time-Series Ranked Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Time-Series Ranked Lower Wick Support

Use this Skill to compute `5日时序排名下影线支撑` / `5D Time-Series Ranked Lower Wick Support` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-time-series-ranked-lower-wick-support
description: Use when computing the 10D Time-Series Ranked Lower Wick Support factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Lower Wick Support

Use this Skill to compute `10日时序排名下影线支撑` / `10D Time-Series Ranked Lower Wick Support` from caller-provided OHLCV data.

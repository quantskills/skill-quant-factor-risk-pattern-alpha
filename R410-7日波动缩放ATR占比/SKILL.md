---
name: quant-real-factor-7d-volatility-scaled-atr-ratio
description: Use when computing the 7D Volatility Scaled ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled ATR Ratio

Use this Skill to compute `7日波动缩放ATR占比` / `7D Volatility Scaled ATR Ratio` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-compressed-upper-wick-pressure
description: Use when computing the 7D Compressed Upper Wick Pressure factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Upper Wick Pressure

Use this Skill to compute `7日压缩上影线压力` / `7D Compressed Upper Wick Pressure` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-z-scored-drawdown-from-high
description: Use when computing the 5D Z-Scored Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Drawdown From High

Use this Skill to compute `5日标准化距高点回撤` / `5D Z-Scored Drawdown From High` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-stability-scaled-rsi-strength
description: Use when computing the 10D Stability Scaled RSI Strength factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled RSI Strength

Use this Skill to compute `10日稳定度缩放RSI强度` / `10D Stability Scaled RSI Strength` from caller-provided OHLCV data.

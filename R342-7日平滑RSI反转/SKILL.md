---
name: quant-real-factor-7d-smoothed-rsi-reversal
description: Use when computing the 7D Smoothed RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed RSI Reversal

Use this Skill to compute `7日平滑RSI反转` / `7D Smoothed RSI Reversal` from caller-provided OHLCV data.

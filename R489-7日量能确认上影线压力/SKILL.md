---
name: quant-real-factor-7d-volume-confirmed-upper-wick-pressure
description: Use when computing the 7D Volume Confirmed Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Upper Wick Pressure

Use this Skill to compute `7日量能确认上影线压力` / `7D Volume Confirmed Upper Wick Pressure` from caller-provided OHLCV data.

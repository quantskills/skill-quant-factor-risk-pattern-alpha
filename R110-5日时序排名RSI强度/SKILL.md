---
name: quant-real-factor-5d-time-series-ranked-rsi-strength
description: Use when computing the 5D Time-Series Ranked RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Time-Series Ranked RSI Strength

Use this Skill to compute `5日时序排名RSI强度` / `5D Time-Series Ranked RSI Strength` from caller-provided OHLCV data.

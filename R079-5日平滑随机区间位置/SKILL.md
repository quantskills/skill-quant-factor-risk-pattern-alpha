---
name: quant-real-factor-5d-smoothed-stochastic-position
description: Use when computing the 5D Smoothed Stochastic Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Stochastic Position

Use this Skill to compute `5日平滑随机区间位置` / `5D Smoothed Stochastic Position` from caller-provided OHLCV data.

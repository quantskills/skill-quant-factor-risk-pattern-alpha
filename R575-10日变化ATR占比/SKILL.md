---
name: quant-real-factor-10d-delta-atr-ratio
description: Use when computing the 10D Delta ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日变化ATR占比` / `10D Delta ATR Ratio` from caller-provided OHLCV data.

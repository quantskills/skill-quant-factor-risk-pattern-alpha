---
name: quant-real-factor-10d-delta-gap-sum
description: Use when computing the 10D Delta Gap Sum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日变化缺口累积` / `10D Delta Gap Sum` from caller-provided OHLCV data.

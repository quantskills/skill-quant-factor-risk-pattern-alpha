---
name: quant-real-factor-10d-volume-confirmed-drawdown-from-high
description: Use when computing the 10D Volume Confirmed Drawdown From High factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Drawdown From High

Use this Skill to compute `10日量能确认距高点回撤` / `10D Volume Confirmed Drawdown From High` from caller-provided OHLCV data.

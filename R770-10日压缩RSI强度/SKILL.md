---
name: quant-real-factor-10d-compressed-rsi-strength
description: Use when computing the 10D Compressed RSI Strength factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed RSI Strength

Use this Skill to compute `10日压缩RSI强度` / `10D Compressed RSI Strength` from caller-provided OHLCV data.

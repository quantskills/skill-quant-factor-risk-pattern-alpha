---
name: quant-real-factor-5d-delta-range-ratio
description: Use when computing the 5D Delta Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Range Ratio

Use this Skill to compute `5日变化振幅占比` / `5D Delta Range Ratio` from caller-provided OHLCV data.

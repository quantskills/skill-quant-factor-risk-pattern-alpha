---
name: quant-real-factor-10d-compressed-atr-ratio
description: Use when computing the 10D Compressed ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed ATR Ratio

Use this Skill to compute `10日压缩ATR占比` / `10D Compressed ATR Ratio` from caller-provided OHLCV data.

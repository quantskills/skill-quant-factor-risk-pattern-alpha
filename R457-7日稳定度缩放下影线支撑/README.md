...
`7日稳定度缩放下影线支撑` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `形态` 类。

### 因子逻辑

```text
stability(lower_wick, window=7)
```
...
- 可用行数: `195295`
- 覆盖率: `0.9917`
- 5日 Rank IC 均值: `0.003940`
- 5日 ICIR: `0.2147`
- 五分组 Q5-Q1 均值: `-0.000107`
- Top 组换手: `0.2493`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Stability Scaled Lower Wick Support` is a real-data-validated framework-neutral OHLCV factor Skill in the `Pattern` family.
...
- Usable rows: `195295`
- Coverage: `0.9917`
- 5-day Rank IC mean: `0.003940`
- 5-day ICIR: `0.2147`
- Quintile Q5-Q1 mean: `-0.000107`

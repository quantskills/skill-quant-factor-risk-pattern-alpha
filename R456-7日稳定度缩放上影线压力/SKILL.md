---
name: quant-real-factor-7d-stability-scaled-upper-wick-pressure
description: Use when computing the 7D Stability Scaled Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Upper Wick Pressure

Use this Skill to compute `7日稳定度缩放上影线压力` / `7D Stability Scaled Upper Wick Pressure` from caller-provided OHLCV data.

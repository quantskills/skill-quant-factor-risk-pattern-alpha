---
name: quant-real-factor-10d-z-scored-realized-volatility
description: Use when computing the 10D Z-Scored Realized Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Realized Volatility

Use this Skill to compute `10日标准化实现波动率` / `10D Z-Scored Realized Volatility` from caller-provided OHLCV data.

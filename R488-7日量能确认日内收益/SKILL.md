---
name: quant-real-factor-7d-volume-confirmed-intraday-return
description: Use when computing the 7D Volume Confirmed Intraday Return factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Intraday Return

Use this Skill to compute `7日量能确认日内收益` / `7D Volume Confirmed Intraday Return` from caller-provided OHLCV data.

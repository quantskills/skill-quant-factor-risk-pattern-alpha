---
name: quant-real-factor-5d-stability-scaled-drawdown-from-high
description: Use when computing the 5D Stability Scaled Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Drawdown From High

Use this Skill to compute `5日稳定度缩放距高点回撤` / `5D Stability Scaled Drawdown From High` from caller-provided OHLCV data.

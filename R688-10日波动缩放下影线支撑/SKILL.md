---
name: quant-real-factor-10d-volatility-scaled-lower-wick-support
description: Use when computing the 10D Volatility Scaled Lower Wick Support factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日波动缩放下影线支撑` / `10D Volatility Scaled Lower Wick Support` from caller-provided OHLCV data.

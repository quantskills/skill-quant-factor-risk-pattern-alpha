---
name: quant-real-factor-7d-z-scored-stochastic-position
description: Use when computing the 7D Z-Scored Stochastic Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Stochastic Position

Use this Skill to compute `7日标准化随机区间位置` / `7D Z-Scored Stochastic Position` from caller-provided OHLCV data.

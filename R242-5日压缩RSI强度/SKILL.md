---
name: quant-real-factor-5d-compressed-rsi-strength
description: Use when computing the 5D Compressed RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed RSI Strength

Use this Skill to compute `5日压缩RSI强度` / `5D Compressed RSI Strength` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-delta-stochastic-position
description: Use when computing the 10D Delta Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Stochastic Position

Use this Skill to compute `10日变化随机区间位置` / `10D Delta Stochastic Position` from caller-provided OHLCV data.

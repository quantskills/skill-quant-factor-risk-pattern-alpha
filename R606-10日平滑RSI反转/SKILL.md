---
name: quant-real-factor-10d-smoothed-rsi-reversal
description: Use when computing the 10D Smoothed RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed RSI Reversal

Use this Skill to compute `10日平滑RSI反转` / `10D Smoothed RSI Reversal` from caller-provided OHLCV data.

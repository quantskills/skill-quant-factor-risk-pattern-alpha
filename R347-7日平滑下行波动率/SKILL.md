---
name: quant-real-factor-7d-smoothed-downside-volatility
description: Use when computing the 7D Smoothed Downside Volatility factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Downside Volatility

Use this Skill to compute `7日平滑下行波动率` / `7D Smoothed Downside Volatility` from caller-provided OHLCV data.

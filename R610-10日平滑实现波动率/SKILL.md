---
name: quant-real-factor-10d-smoothed-realized-volatility
description: Use when computing the 10D Smoothed Realized Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Realized Volatility

Use this Skill to compute `10日平滑实现波动率` / `10D Smoothed Realized Volatility` from caller-provided OHLCV data.

...
`5日稳定度缩放实现波动率` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `波动率` 类。

### 因子逻辑

```text
stability(realized_vol, window=5)
```
...
`5D Stability Scaled Realized Volatility` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volatility` family.
...
- Usable rows: `195307`
- Coverage: `0.9917`
- 5-day Rank IC mean: `-0.006452`
- 5-day ICIR: `-0.3154`
- Quintile Q5-Q1 mean: `-0.000325`
- Top-quintile turnover: `0.3031`

---
name: quant-real-factor-7d-z-scored-rsi-strength
description: Use when computing the 7D Z-Scored RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored RSI Strength

Use this Skill to compute `7日标准化RSI强度` / `7D Z-Scored RSI Strength` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-compressed-gap-sum
description: Use when computing the 10D Compressed Gap Sum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Gap Sum

Use this Skill to compute `10日压缩缺口累积` / `10D Compressed Gap Sum` from caller-provided OHLCV data.

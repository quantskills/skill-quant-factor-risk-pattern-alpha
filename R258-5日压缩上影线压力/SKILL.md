---
name: quant-real-factor-5d-compressed-upper-wick-pressure
description: Use when computing the 5D Compressed Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Upper Wick Pressure

Use this Skill to compute `5日压缩上影线压力` / `5D Compressed Upper Wick Pressure` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-time-series-ranked-upper-wick-pressure
description: Use when computing the 10D Time-Series Ranked Upper Wick Pressure factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Upper Wick Pressure

Use this Skill to compute `10日时序排名上影线压力` / `10D Time-Series Ranked Upper Wick Pressure` from caller-provided OHLCV data.

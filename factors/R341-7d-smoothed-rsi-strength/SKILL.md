---
name: quant-real-factor-7d-smoothed-rsi-strength
description: Use when computing the 7D Smoothed RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed RSI Strength

Use this Skill to compute `7日平滑RSI强度` / `7D Smoothed RSI Strength` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-compressed-downside-volatility
description: Use when computing the 10D Compressed Downside Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Downside Volatility

Use this Skill to compute `10日压缩下行波动率` / `10D Compressed Downside Volatility` from caller-provided OHLCV data.

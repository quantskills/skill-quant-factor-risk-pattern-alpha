---
name: quant-real-factor-10d-volume-confirmed-rsi-reversal
description: Use when computing the 10D Volume Confirmed RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed RSI Reversal

Use this Skill to compute `10日量能确认RSI反转` / `10D Volume Confirmed RSI Reversal` from caller-provided OHLCV data.

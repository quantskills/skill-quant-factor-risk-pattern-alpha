---
name: quant-real-factor-7d-time-series-ranked-drawdown-from-high
description: Use when computing the 7D Time-Series Ranked Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Time-Series Ranked Drawdown From High

Use this Skill to compute `7日时序排名距高点回撤` / `7D Time-Series Ranked Drawdown From High` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-volume-confirmed-rsi-strength
description: Use when computing the 10D Volume Confirmed RSI Strength factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed RSI Strength

Use this Skill to compute `10日量能确认RSI强度` / `10D Volume Confirmed RSI Strength` from caller-provided OHLCV data.

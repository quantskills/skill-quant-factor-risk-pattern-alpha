---
name: quant-real-factor-5d-z-scored-upper-wick-pressure
description: Use when computing the 5D Z-Scored Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Upper Wick Pressure

Use this Skill to compute `5日标准化上影线压力` / `5D Z-Scored Upper Wick Pressure` from caller-provided OHLCV data.

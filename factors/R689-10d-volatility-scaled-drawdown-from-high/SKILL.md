---
name: quant-real-factor-10d-volatility-scaled-drawdown-from-high
description: Use when computing the 10D Volatility Scaled Drawdown From High factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Drawdown From High

Use this Skill to compute `10日波动缩放距高点回撤` / `10D Volatility Scaled Drawdown From High` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-z-scored-atr-ratio
description: Use when computing the 7D Z-Scored ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored ATR Ratio

Use this Skill to compute `7日标准化ATR占比` / `7D Z-Scored ATR Ratio` from caller-provided OHLCV data.

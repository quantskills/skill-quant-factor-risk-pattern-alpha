---
name: quant-real-factor-10d-volume-confirmed-downside-volatility
description: Use when computing the 10D Volume Confirmed Downside Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Downside Volatility

Use this Skill to compute `10日量能确认下行波动率` / `10D Volume Confirmed Downside Volatility` from caller-provided OHLCV data.

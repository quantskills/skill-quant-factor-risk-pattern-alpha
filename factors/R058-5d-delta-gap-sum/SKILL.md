---
name: quant-real-factor-5d-delta-gap-sum
description: Use when computing the 5D Delta Gap Sum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日变化缺口累积` / `5D Delta Gap Sum` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-volume-confirmed-lower-wick-support
description: Use when computing the 7D Volume Confirmed Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Lower Wick Support

Use this Skill to compute `7日量能确认下影线支撑` / `7D Volume Confirmed Lower Wick Support` from caller-provided OHLCV data.

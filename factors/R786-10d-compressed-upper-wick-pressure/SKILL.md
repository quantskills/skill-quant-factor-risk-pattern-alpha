---
name: quant-real-factor-10d-compressed-upper-wick-pressure
description: Use when computing the 10D Compressed Upper Wick Pressure factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Upper Wick Pressure

Use this Skill to compute `10日压缩上影线压力` / `10D Compressed Upper Wick Pressure` from caller-provided OHLCV data.

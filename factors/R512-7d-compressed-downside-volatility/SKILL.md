---
name: quant-real-factor-7d-compressed-downside-volatility
description: Use when computing the 7D Compressed Downside Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Downside Volatility

Use this Skill to compute `7日压缩下行波动率` / `7D Compressed Downside Volatility` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-z-scored-rsi-strength
description: Use when computing the 5D Z-Scored RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored RSI Strength

Use this Skill to compute `5日标准化RSI强度` / `5D Z-Scored RSI Strength` from caller-provided OHLCV data.

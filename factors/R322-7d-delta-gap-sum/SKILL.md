---
name: quant-real-factor-7d-delta-gap-sum
description: Use when computing the 7D Delta Gap Sum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日变化缺口累积` / `7D Delta Gap Sum` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-time-series-ranked-atr-ratio
description: Use when computing the 10D Time-Series Ranked ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked ATR Ratio

Use this Skill to compute `10日时序排名ATR占比` / `10D Time-Series Ranked ATR Ratio` from caller-provided OHLCV data.

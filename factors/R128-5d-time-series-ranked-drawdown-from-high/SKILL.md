---
name: quant-real-factor-5d-time-series-ranked-drawdown-from-high
description: Use when computing the 5D Time-Series Ranked Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Time-Series Ranked Drawdown From High

Use this Skill to compute `5日时序排名距高点回撤` / `5D Time-Series Ranked Drawdown From High` from caller-provided OHLCV data.

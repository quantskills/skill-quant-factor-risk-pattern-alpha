---
name: quant-real-factor-7d-delta-atr-ratio
description: Use when computing the 7D Delta ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日变化ATR占比` / `7D Delta ATR Ratio` from caller-provided OHLCV data.

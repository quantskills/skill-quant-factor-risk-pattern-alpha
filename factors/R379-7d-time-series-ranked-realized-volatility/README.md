...
`7日时序排名实现波动率` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `波动率` 类。

### 因子逻辑

```text
rank(realized_vol, window=7)
```
...
- 可用行数: `195159`
- 覆盖率: `0.9910`
- 5日 Rank IC 均值: `-0.006307`
- 5日 ICIR: `-0.3088`
- 五分组 Q5-Q1 均值: `0.000572`
- Top 组换手: `0.3417`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Time-Series Ranked Realized Volatility` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volatility` family.
...
- Usable rows: `195159`
- Coverage: `0.9910`
- 5-day Rank IC mean: `-0.006307`
- 5-day ICIR: `-0.3088`
- Quintile Q5-Q1 mean: `0.000572`
- Top-quintile turnover: `0.3417`

---
name: quant-real-factor-7d-compressed-rsi-strength
description: Use when computing the 7D Compressed RSI Strength factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed RSI Strength

Use this Skill to compute `7日压缩RSI强度` / `7D Compressed RSI Strength` from caller-provided OHLCV data.

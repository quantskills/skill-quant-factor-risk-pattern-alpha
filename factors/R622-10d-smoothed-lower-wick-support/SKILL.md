---
name: quant-real-factor-10d-smoothed-lower-wick-support
description: Use when computing the 10D Smoothed Lower Wick Support factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Lower Wick Support

Use this Skill to compute `10日平滑下影线支撑` / `10D Smoothed Lower Wick Support` from caller-provided OHLCV data.

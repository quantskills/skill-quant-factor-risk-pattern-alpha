---
name: quant-real-factor-5d-volume-confirmed-rsi-strength
description: Use when computing the 5D Volume Confirmed RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed RSI Strength

Use this Skill to compute `5日量能确认RSI强度` / `5D Volume Confirmed RSI Strength` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-volume-confirmed-gap-sum
description: Use when computing the 7D Volume Confirmed Gap Sum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Gap Sum

Use this Skill to compute `7日量能确认缺口累积` / `7D Volume Confirmed Gap Sum` from caller-provided OHLCV data.

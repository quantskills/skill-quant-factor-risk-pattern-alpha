---
name: quant-real-factor-5d-volatility-scaled-lower-wick-support
description: Use when computing the 5D Volatility Scaled Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled Lower Wick Support

Use this Skill to compute `5日波动缩放下影线支撑` / `5D Volatility Scaled Lower Wick Support` from caller-provided OHLCV data.

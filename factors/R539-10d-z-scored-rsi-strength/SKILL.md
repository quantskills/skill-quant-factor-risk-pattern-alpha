---
name: quant-real-factor-10d-z-scored-rsi-strength
description: Use when computing the 10D Z-Scored RSI Strength factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored RSI Strength

Use this Skill to compute `10日标准化RSI强度` / `10D Z-Scored RSI Strength` from caller-provided OHLCV data.

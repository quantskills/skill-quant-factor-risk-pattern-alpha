---
name: quant-real-factor-5d-smoothed-atr-ratio
description: Use when computing the 5D Smoothed ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed ATR Ratio

Use this Skill to compute `5日平滑ATR占比` / `5D Smoothed ATR Ratio` from caller-provided OHLCV data.

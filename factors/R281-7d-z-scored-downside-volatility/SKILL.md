---
name: quant-real-factor-7d-z-scored-downside-volatility
description: Use when computing the 7D Z-Scored Downside Volatility factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Downside Volatility

Use this Skill to compute `7日标准化下行波动率` / `7D Z-Scored Downside Volatility` from caller-provided OHLCV data.

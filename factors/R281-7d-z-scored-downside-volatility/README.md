...
`7日标准化下行波动率` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `波动率` 类。

### 因子逻辑

```text
z(downside_vol, window=7)
```
...
`7D Z-Scored Downside Volatility` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volatility` family.
...
- Usable rows: `195297`
- Coverage: `0.9917`
- 5-day Rank IC mean: `-0.006470`
- 5-day ICIR: `-0.2823`
- Quintile Q5-Q1 mean: `-0.000013`
- Top-quintile turnover: `0.2592`

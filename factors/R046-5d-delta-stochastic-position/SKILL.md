---
name: quant-real-factor-5d-delta-stochastic-position
description: Use when computing the 5D Delta Stochastic Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Stochastic Position

Use this Skill to compute `5日变化随机区间位置` / `5D Delta Stochastic Position` from caller-provided OHLCV data.

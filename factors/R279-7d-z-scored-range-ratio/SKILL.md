---
name: quant-real-factor-7d-z-scored-range-ratio
description: Use when computing the 7D Z-Scored Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Range Ratio

Use this Skill to compute `7日标准化振幅占比` / `7D Z-Scored Range Ratio` from caller-provided OHLCV data.

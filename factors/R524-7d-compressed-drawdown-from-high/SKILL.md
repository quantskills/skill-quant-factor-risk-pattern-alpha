---
name: quant-real-factor-7d-compressed-drawdown-from-high
description: Use when computing the 7D Compressed Drawdown From High factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Drawdown From High

Use this Skill to compute `7日压缩距高点回撤` / `7D Compressed Drawdown From High` from caller-provided OHLCV data.

...
`7日时序排名RSI反转` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `震荡` 类。

### 因子逻辑

```text
rank(rsi_reversal, window=7)
```
...
- 可用行数: `195088`
- 覆盖率: `0.9906`
- 5日 Rank IC 均值: `-0.007970`
- 5日 ICIR: `-0.2933`
- 五分组 Q5-Q1 均值: `-0.000750`
- Top 组换手: `0.3942`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Time-Series Ranked RSI Reversal` is a real-data-validated framework-neutral OHLCV factor Skill in the `Oscillator` family.
...
- Usable rows: `195088`
- Coverage: `0.9906`
- 5-day Rank IC mean: `-0.007970`
- 5-day ICIR: `-0.2933`
- Quintile Q5-Q1 mean: `-0.000750`
- Top-quintile turnover: `0.3942`

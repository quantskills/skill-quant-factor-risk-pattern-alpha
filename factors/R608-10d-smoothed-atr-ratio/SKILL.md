---
name: quant-real-factor-10d-smoothed-atr-ratio
description: Use when computing the 10D Smoothed ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed ATR Ratio

Use this Skill to compute `10日平滑ATR占比` / `10D Smoothed ATR Ratio` from caller-provided OHLCV data.

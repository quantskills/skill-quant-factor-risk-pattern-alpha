---
name: quant-real-factor-10d-delta-upper-wick-pressure
description: Use when computing the 10D Delta Upper Wick Pressure factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Upper Wick Pressure

Use this Skill to compute `10日变化上影线压力` / `10D Delta Upper Wick Pressure` from caller-provided OHLCV data.

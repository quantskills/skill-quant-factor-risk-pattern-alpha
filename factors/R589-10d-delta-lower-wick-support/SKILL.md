---
name: quant-real-factor-10d-delta-lower-wick-support
description: Use when computing the 10D Delta Lower Wick Support factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Lower Wick Support

Use this Skill to compute `10日变化下影线支撑` / `10D Delta Lower Wick Support` from caller-provided OHLCV data.

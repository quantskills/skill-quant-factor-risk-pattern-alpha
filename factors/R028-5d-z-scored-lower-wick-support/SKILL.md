---
name: quant-real-factor-5d-z-scored-lower-wick-support
description: Use when computing the 5D Z-Scored Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Lower Wick Support

Use this Skill to compute `5日标准化下影线支撑` / `5D Z-Scored Lower Wick Support` from caller-provided OHLCV data.

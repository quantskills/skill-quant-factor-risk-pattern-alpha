---
name: quant-real-factor-7d-delta-drawdown-from-high
description: Use when computing the 7D Delta Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Drawdown From High

Use this Skill to compute `7日变化距高点回撤` / `7D Delta Drawdown From High` from caller-provided OHLCV data.

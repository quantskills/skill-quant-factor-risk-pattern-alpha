---
name: quant-real-factor-5d-volume-confirmed-rsi-reversal
description: Use when computing the 5D Volume Confirmed RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed RSI Reversal

Use this Skill to compute `5日量能确认RSI反转` / `5D Volume Confirmed RSI Reversal` from caller-provided OHLCV data.

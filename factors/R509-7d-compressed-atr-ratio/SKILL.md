---
name: quant-real-factor-7d-compressed-atr-ratio
description: Use when computing the 7D Compressed ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed ATR Ratio

Use this Skill to compute `7日压缩ATR占比` / `7D Compressed ATR Ratio` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-stability-scaled-intraday-return
description: Use when computing the 10D Stability Scaled Intraday Return factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Intraday Return

Use this Skill to compute `10日稳定度缩放日内收益` / `10D Stability Scaled Intraday Return` from caller-provided OHLCV data.

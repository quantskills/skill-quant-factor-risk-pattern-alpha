---
name: quant-real-factor-10d-z-scored-intraday-return
description: Use when computing the 10D Z-Scored Intraday Return factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Intraday Return

Use this Skill to compute `10日标准化日内收益` / `10D Z-Scored Intraday Return` from caller-provided OHLCV data.

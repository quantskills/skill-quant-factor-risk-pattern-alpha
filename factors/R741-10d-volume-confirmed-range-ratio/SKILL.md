---
name: quant-real-factor-10d-volume-confirmed-range-ratio
description: Use when computing the 10D Volume Confirmed Range Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Range Ratio

Use this Skill to compute `10日量能确认振幅占比` / `10D Volume Confirmed Range Ratio` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-compressed-atr-ratio
description: Use when computing the 5D Compressed ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed ATR Ratio

Use this Skill to compute `5日压缩ATR占比` / `5D Compressed ATR Ratio` from caller-provided OHLCV data.

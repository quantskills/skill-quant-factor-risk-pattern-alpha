---
name: quant-real-factor-10d-z-scored-lower-wick-support
description: Use when computing the 10D Z-Scored Lower Wick Support factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Lower Wick Support

Use this Skill to compute `10日标准化下影线支撑` / `10D Z-Scored Lower Wick Support` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-volume-confirmed-upper-wick-pressure
description: Use when computing the 10D Volume Confirmed Upper Wick Pressure factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Upper Wick Pressure

Use this Skill to compute `10日量能确认上影线压力` / `10D Volume Confirmed Upper Wick Pressure` from caller-provided OHLCV data.

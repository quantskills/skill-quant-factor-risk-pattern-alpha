---
name: quant-real-factor-7d-volume-confirmed-range-ratio
description: Use when computing the 7D Volume Confirmed Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Range Ratio

Use this Skill to compute `7日量能确认振幅占比` / `7D Volume Confirmed Range Ratio` from caller-provided OHLCV data.

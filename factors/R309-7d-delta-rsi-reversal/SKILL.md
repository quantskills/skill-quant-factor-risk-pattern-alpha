---
name: quant-real-factor-7d-delta-rsi-reversal
description: Use when computing the 7D Delta RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日变化RSI反转` / `7D Delta RSI Reversal` from caller-provided OHLCV data.

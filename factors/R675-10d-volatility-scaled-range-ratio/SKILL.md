---
name: quant-real-factor-10d-volatility-scaled-range-ratio
description: Use when computing the 10D Volatility Scaled Range Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Range Ratio

Use this Skill to compute `10日波动缩放振幅占比` / `10D Volatility Scaled Range Ratio` from caller-provided OHLCV data.

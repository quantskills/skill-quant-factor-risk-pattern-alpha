---
name: quant-real-factor-10d-z-scored-downside-volatility
description: Use when computing the 10D Z-Scored Downside Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Downside Volatility

Use this Skill to compute `10日标准化下行波动率` / `10D Z-Scored Downside Volatility` from caller-provided OHLCV data.

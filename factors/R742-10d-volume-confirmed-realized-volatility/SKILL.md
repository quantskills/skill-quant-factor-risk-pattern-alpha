---
name: quant-real-factor-10d-volume-confirmed-realized-volatility
description: Use when computing the 10D Volume Confirmed Realized Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Realized Volatility

Use this Skill to compute `10日量能确认实现波动率` / `10D Volume Confirmed Realized Volatility` from caller-provided OHLCV data.

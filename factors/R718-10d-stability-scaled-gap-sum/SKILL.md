---
name: quant-real-factor-10d-stability-scaled-gap-sum
description: Use when computing the 10D Stability Scaled Gap Sum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Gap Sum

Use this Skill to compute `10日稳定度缩放缺口累积` / `10D Stability Scaled Gap Sum` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-time-series-ranked-lower-wick-support
description: Use when computing the 7D Time-Series Ranked Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Time-Series Ranked Lower Wick Support

Use this Skill to compute `7日时序排名下影线支撑` / `7D Time-Series Ranked Lower Wick Support` from caller-provided OHLCV data.

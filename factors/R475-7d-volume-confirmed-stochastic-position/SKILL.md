---
name: quant-real-factor-7d-volume-confirmed-stochastic-position
description: Use when computing the 7D Volume Confirmed Stochastic Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Stochastic Position

Use this Skill to compute `7日量能确认随机区间位置` / `7D Volume Confirmed Stochastic Position` from caller-provided OHLCV data.

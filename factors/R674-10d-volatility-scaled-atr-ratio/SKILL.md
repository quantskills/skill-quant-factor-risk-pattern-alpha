---
name: quant-real-factor-10d-volatility-scaled-atr-ratio
description: Use when computing the 10D Volatility Scaled ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled ATR Ratio

Use this Skill to compute `10日波动缩放ATR占比` / `10D Volatility Scaled ATR Ratio` from caller-provided OHLCV data.

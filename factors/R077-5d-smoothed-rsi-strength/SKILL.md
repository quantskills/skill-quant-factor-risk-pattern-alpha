---
name: quant-real-factor-5d-smoothed-rsi-strength
description: Use when computing the 5D Smoothed RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed RSI Strength

Use this Skill to compute `5日平滑RSI强度` / `5D Smoothed RSI Strength` from caller-provided OHLCV data.

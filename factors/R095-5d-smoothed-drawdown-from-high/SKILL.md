---
name: quant-real-factor-5d-smoothed-drawdown-from-high
description: Use when computing the 5D Smoothed Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Drawdown From High

Use this Skill to compute `5日平滑距高点回撤` / `5D Smoothed Drawdown From High` from caller-provided OHLCV data.

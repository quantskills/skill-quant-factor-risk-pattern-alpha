---
name: quant-real-factor-10d-volatility-scaled-downside-volatility
description: Use when computing the 10D Volatility Scaled Downside Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Downside Volatility

Use this Skill to compute `10日波动缩放下行波动率` / `10D Volatility Scaled Downside Volatility` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-delta-drawdown-from-high
description: Use when computing the 5D Delta Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Drawdown From High

Use this Skill to compute `5日变化距高点回撤` / `5D Delta Drawdown From High` from caller-provided OHLCV data.

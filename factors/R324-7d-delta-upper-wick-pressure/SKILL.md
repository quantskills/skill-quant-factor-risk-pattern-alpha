---
name: quant-real-factor-7d-delta-upper-wick-pressure
description: Use when computing the 7D Delta Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Upper Wick Pressure

Use this Skill to compute `7日变化上影线压力` / `7D Delta Upper Wick Pressure` from caller-provided OHLCV data.

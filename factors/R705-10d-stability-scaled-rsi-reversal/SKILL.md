---
name: quant-real-factor-10d-stability-scaled-rsi-reversal
description: Use when computing the 10D Stability Scaled RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled RSI Reversal

Use this Skill to compute `10日稳定度缩放RSI反转` / `10D Stability Scaled RSI Reversal` from caller-provided OHLCV data.

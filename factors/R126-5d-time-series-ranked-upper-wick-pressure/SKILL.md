---
name: quant-real-factor-5d-time-series-ranked-upper-wick-pressure
description: Use when computing the 5D Time-Series Ranked Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Time-Series Ranked Upper Wick Pressure

Use this Skill to compute `5日时序排名上影线压力` / `5D Time-Series Ranked Upper Wick Pressure` from caller-provided OHLCV data.

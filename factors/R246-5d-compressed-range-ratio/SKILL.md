---
name: quant-real-factor-5d-compressed-range-ratio
description: Use when computing the 5D Compressed Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Range Ratio

Use this Skill to compute `5日压缩振幅占比` / `5D Compressed Range Ratio` from caller-provided OHLCV data.

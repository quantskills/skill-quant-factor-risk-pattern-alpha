---
name: quant-real-factor-7d-time-series-ranked-upper-wick-pressure
description: Use when computing the 7D Time-Series Ranked Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Time-Series Ranked Upper Wick Pressure

Use this Skill to compute `7日时序排名上影线压力` / `7D Time-Series Ranked Upper Wick Pressure` from caller-provided OHLCV data.

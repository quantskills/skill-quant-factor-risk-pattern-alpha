---
name: quant-real-factor-5d-delta-intraday-return
description: Use when computing the 5D Delta Intraday Return factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Intraday Return

Use this Skill to compute `5日变化日内收益` / `5D Delta Intraday Return` from caller-provided OHLCV data.

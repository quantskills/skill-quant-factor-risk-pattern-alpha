---
name: quant-real-factor-7d-smoothed-atr-ratio
description: Use when computing the 7D Smoothed ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed ATR Ratio

Use this Skill to compute `7日平滑ATR占比` / `7D Smoothed ATR Ratio` from caller-provided OHLCV data.

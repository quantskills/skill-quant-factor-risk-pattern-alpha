---
name: quant-real-factor-7d-compressed-stochastic-position
description: Use when computing the 7D Compressed Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Stochastic Position

Use this Skill to compute `7日压缩随机区间位置` / `7D Compressed Stochastic Position` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-smoothed-rsi-reversal
description: Use when computing the 5D Smoothed RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed RSI Reversal

Use this Skill to compute `5日平滑RSI反转` / `5D Smoothed RSI Reversal` from caller-provided OHLCV data.

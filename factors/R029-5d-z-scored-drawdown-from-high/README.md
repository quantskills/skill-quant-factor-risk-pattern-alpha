...
`5日标准化距高点回撤` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `回撤` 类。
...
`5D Z-Scored Drawdown From High` is a real-data-validated framework-neutral OHLCV factor Skill in the `Drawdown` family.
...
- Usable rows: `195437`
- Coverage: `0.9924`
- 5-day Rank IC mean: `-0.004683`
- 5-day ICIR: `-0.1718`
- Quintile Q5-Q1 mean: `-0.000608`
- Top-quintile turnover: `0.5290`

---
name: quant-real-factor-5d-delta-downside-volatility
description: Use when computing the 5D Delta Downside Volatility factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Downside Volatility

Use this Skill to compute `5日变化下行波动率` / `5D Delta Downside Volatility` from caller-provided OHLCV data.

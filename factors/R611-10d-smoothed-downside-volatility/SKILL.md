---
name: quant-real-factor-10d-smoothed-downside-volatility
description: Use when computing the 10D Smoothed Downside Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Downside Volatility

Use this Skill to compute `10日平滑下行波动率` / `10D Smoothed Downside Volatility` from caller-provided OHLCV data.

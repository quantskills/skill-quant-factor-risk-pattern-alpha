---
name: quant-real-factor-10d-smoothed-gap-sum
description: Use when computing the 10D Smoothed Gap Sum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Gap Sum

Use this Skill to compute `10日平滑缺口累积` / `10D Smoothed Gap Sum` from caller-provided OHLCV data.

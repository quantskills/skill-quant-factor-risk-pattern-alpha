---
name: quant-real-factor-7d-volume-confirmed-atr-ratio
description: Use when computing the 7D Volume Confirmed ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed ATR Ratio

Use this Skill to compute `7日量能确认ATR占比` / `7D Volume Confirmed ATR Ratio` from caller-provided OHLCV data.

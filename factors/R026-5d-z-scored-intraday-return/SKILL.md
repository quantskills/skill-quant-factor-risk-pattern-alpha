---
name: quant-real-factor-5d-z-scored-intraday-return
description: Use when computing the 5D Z-Scored Intraday Return factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Intraday Return

Use this Skill to compute `5日标准化日内收益` / `5D Z-Scored Intraday Return` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-z-scored-gap-sum
description: Use when computing the 10D Z-Scored Gap Sum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Gap Sum

Use this Skill to compute `10日标准化缺口累积` / `10D Z-Scored Gap Sum` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-stability-scaled-atr-ratio
description: Use when computing the 7D Stability Scaled ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled ATR Ratio

Use this Skill to compute `7日稳定度缩放ATR占比` / `7D Stability Scaled ATR Ratio` from caller-provided OHLCV data.

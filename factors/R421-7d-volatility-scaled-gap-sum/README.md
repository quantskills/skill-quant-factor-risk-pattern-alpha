...
`7日波动缩放缺口累积` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `形态` 类。

### 因子逻辑

```text
vol_scaled(gap_sum, window=7)
```
...
- 可用行数: `195455`
- 覆盖率: `0.9925`
- 5日 Rank IC 均值: `0.013578`
- 5日 ICIR: `0.5330`
- 五分组 Q5-Q1 均值: `0.000512`
- Top 组换手: `0.2934`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Volatility Scaled Gap Sum` is a real-data-validated framework-neutral OHLCV factor Skill in the `Pattern` family.
...
- Usable rows: `195455`
- Coverage: `0.9925`
- 5-day Rank IC mean: `0.013578`
- 5-day ICIR: `0.5330`
- Quintile Q5-Q1 mean: `0.000512`

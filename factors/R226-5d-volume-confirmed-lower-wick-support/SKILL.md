---
name: quant-real-factor-5d-volume-confirmed-lower-wick-support
description: Use when computing the 5D Volume Confirmed Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Lower Wick Support

Use this Skill to compute `5日量能确认下影线支撑` / `5D Volume Confirmed Lower Wick Support` from caller-provided OHLCV data.

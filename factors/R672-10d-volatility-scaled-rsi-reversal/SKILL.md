---
name: quant-real-factor-10d-volatility-scaled-rsi-reversal
description: Use when computing the 10D Volatility Scaled RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled RSI Reversal

Use this Skill to compute `10日波动缩放RSI反转` / `10D Volatility Scaled RSI Reversal` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-delta-rsi-reversal
description: Use when computing the 10D Delta RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta RSI Reversal

Use this Skill to compute `10日变化RSI反转` / `10D Delta RSI Reversal` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-time-series-ranked-rsi-reversal
description: Use when computing the 10D Time-Series Ranked RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked RSI Reversal

Use this Skill to compute `10日时序排名RSI反转` / `10D Time-Series Ranked RSI Reversal` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-compressed-realized-volatility
description: Use when computing the 10D Compressed Realized Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Realized Volatility

Use this Skill to compute `10日压缩实现波动率` / `10D Compressed Realized Volatility` from caller-provided OHLCV data.

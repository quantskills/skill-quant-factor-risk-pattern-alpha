---
name: quant-real-factor-10d-delta-downside-volatility
description: Use when computing the 10D Delta Downside Volatility factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Downside Volatility

Use this Skill to compute `10日变化下行波动率` / `10D Delta Downside Volatility` from caller-provided OHLCV data.

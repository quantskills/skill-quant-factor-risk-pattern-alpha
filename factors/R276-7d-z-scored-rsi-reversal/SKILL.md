---
name: quant-real-factor-7d-z-scored-rsi-reversal
description: Use when computing the 7D Z-Scored RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored RSI Reversal

Use this Skill to compute `7日标准化RSI反转` / `7D Z-Scored RSI Reversal` from caller-provided OHLCV data.

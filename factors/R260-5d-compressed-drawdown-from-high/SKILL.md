---
name: quant-real-factor-5d-compressed-drawdown-from-high
description: Use when computing the 5D Compressed Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Drawdown From High

Use this Skill to compute `5日压缩距高点回撤` / `5D Compressed Drawdown From High` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-volume-confirmed-atr-ratio
description: Use when computing the 5D Volume Confirmed ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed ATR Ratio

Use this Skill to compute `5日量能确认ATR占比` / `5D Volume Confirmed ATR Ratio` from caller-provided OHLCV data.

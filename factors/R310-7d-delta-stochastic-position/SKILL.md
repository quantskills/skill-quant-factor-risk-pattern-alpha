---
name: quant-real-factor-7d-delta-stochastic-position
description: Use when computing the 7D Delta Stochastic Position factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Stochastic Position

Use this Skill to compute `7日变化随机区间位置` / `7D Delta Stochastic Position` from caller-provided OHLCV data.

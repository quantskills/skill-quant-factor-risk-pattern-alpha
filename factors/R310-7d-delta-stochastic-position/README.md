...
`7日变化随机区间位置` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `震荡` 类。

### 因子逻辑

```text
delta(stoch, window=7)
```
...
- 可用行数: `195751`
- 覆盖率: `0.9940`
- 5日 Rank IC 均值: `-0.009874`
- 5日 ICIR: `-0.3508`
- 五分组 Q5-Q1 均值: `-0.000839`
- Top 组换手: `0.8446`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Delta Stochastic Position` is a real-data-validated framework-neutral OHLCV factor Skill in the `Oscillator` family.
...
- Usable rows: `195751`
- Coverage: `0.9940`
- 5-day Rank IC mean: `-0.009874`
- 5-day ICIR: `-0.3508`
- Quintile Q5-Q1 mean: `-0.000839`
- Top-quintile turnover: `0.8446`

...
`5日标准化缺口累积` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `形态` 类。
...
- 可用行数: `195302`
- 覆盖率: `0.9917`
- 5日 Rank IC 均值: `0.006022`
- 5日 ICIR: `0.2565`
- 五分组 Q5-Q1 均值: `0.000605`
- Top 组换手: `0.3795`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Z-Scored Gap Sum` is a real-data-validated framework-neutral OHLCV factor Skill in the `Pattern` family.
...
- Usable rows: `195302`
- Coverage: `0.9917`
- 5-day Rank IC mean: `0.006022`
- 5-day ICIR: `0.2565`
- Quintile Q5-Q1 mean: `0.000605`
- Top-quintile turnover: `0.3795`

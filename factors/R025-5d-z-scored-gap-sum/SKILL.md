---
name: quant-real-factor-5d-z-scored-gap-sum
description: Use when computing the 5D Z-Scored Gap Sum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日标准化缺口累积` / `5D Z-Scored Gap Sum` from caller-provided OHLCV data.

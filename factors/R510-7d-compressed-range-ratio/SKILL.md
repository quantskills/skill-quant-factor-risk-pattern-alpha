---
name: quant-real-factor-7d-compressed-range-ratio
description: Use when computing the 7D Compressed Range Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Range Ratio

Use this Skill to compute `7日压缩振幅占比` / `7D Compressed Range Ratio` from caller-provided OHLCV data.

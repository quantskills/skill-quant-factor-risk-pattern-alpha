---
name: quant-real-factor-5d-delta-rsi-strength
description: Use when computing the 5D Delta RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta RSI Strength

Use this Skill to compute `5日变化RSI强度` / `5D Delta RSI Strength` from caller-provided OHLCV data.

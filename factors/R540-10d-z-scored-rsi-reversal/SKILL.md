---
name: quant-real-factor-10d-z-scored-rsi-reversal
description: Use when computing the 10D Z-Scored RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored RSI Reversal

Use this Skill to compute `10日标准化RSI反转` / `10D Z-Scored RSI Reversal` from caller-provided OHLCV data.

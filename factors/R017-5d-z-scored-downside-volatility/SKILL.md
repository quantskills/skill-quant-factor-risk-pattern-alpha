---
name: quant-real-factor-5d-z-scored-downside-volatility
description: Use when computing the 5D Z-Scored Downside Volatility factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Downside Volatility

Use this Skill to compute `5日标准化下行波动率` / `5D Z-Scored Downside Volatility` from caller-provided OHLCV data.

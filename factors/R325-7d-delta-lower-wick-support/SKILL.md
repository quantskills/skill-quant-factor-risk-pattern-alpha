---
name: quant-real-factor-7d-delta-lower-wick-support
description: Use when computing the 7D Delta Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Lower Wick Support

Use this Skill to compute `7日变化下影线支撑` / `7D Delta Lower Wick Support` from caller-provided OHLCV data.

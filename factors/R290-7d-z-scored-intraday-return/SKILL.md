---
name: quant-real-factor-7d-z-scored-intraday-return
description: Use when computing the 7D Z-Scored Intraday Return factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Intraday Return

Use this Skill to compute `7日标准化日内收益` / `7D Z-Scored Intraday Return` from caller-provided OHLCV data.

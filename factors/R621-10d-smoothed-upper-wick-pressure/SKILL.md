---
name: quant-real-factor-10d-smoothed-upper-wick-pressure
description: Use when computing the 10D Smoothed Upper Wick Pressure factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Upper Wick Pressure

Use this Skill to compute `10日平滑上影线压力` / `10D Smoothed Upper Wick Pressure` from caller-provided OHLCV data.

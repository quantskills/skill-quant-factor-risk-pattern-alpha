---
name: quant-real-factor-10d-volume-confirmed-atr-ratio
description: Use when computing the 10D Volume Confirmed ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed ATR Ratio

Use this Skill to compute `10日量能确认ATR占比` / `10D Volume Confirmed ATR Ratio` from caller-provided OHLCV data.

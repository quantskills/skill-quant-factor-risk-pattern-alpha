---
name: quant-real-factor-7d-smoothed-range-ratio
description: Use when computing the 7D Smoothed Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Range Ratio

Use this Skill to compute `7日平滑振幅占比` / `7D Smoothed Range Ratio` from caller-provided OHLCV data.

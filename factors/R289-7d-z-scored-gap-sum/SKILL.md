---
name: quant-real-factor-7d-z-scored-gap-sum
description: Use when computing the 7D Z-Scored Gap Sum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日标准化缺口累积` / `7D Z-Scored Gap Sum` from caller-provided OHLCV data.

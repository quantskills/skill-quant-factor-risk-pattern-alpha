---
name: quant-real-factor-7d-volume-confirmed-rsi-strength
description: Use when computing the 7D Volume Confirmed RSI Strength factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed RSI Strength

Use this Skill to compute `7日量能确认RSI强度` / `7D Volume Confirmed RSI Strength` from caller-provided OHLCV data.

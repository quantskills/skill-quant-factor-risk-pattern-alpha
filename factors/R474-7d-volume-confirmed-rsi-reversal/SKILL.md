---
name: quant-real-factor-7d-volume-confirmed-rsi-reversal
description: Use when computing the 7D Volume Confirmed RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed RSI Reversal

Use this Skill to compute `7日量能确认RSI反转` / `7D Volume Confirmed RSI Reversal` from caller-provided OHLCV data.

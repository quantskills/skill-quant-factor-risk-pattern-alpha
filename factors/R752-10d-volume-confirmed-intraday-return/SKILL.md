---
name: quant-real-factor-10d-volume-confirmed-intraday-return
description: Use when computing the 10D Volume Confirmed Intraday Return factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Intraday Return

Use this Skill to compute `10日量能确认日内收益` / `10D Volume Confirmed Intraday Return` from caller-provided OHLCV data.

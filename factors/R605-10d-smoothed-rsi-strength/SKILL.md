---
name: quant-real-factor-10d-smoothed-rsi-strength
description: Use when computing the 10D Smoothed RSI Strength factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed RSI Strength

Use this Skill to compute `10日平滑RSI强度` / `10D Smoothed RSI Strength` from caller-provided OHLCV data.

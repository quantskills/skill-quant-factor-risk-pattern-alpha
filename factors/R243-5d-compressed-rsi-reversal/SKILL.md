---
name: quant-real-factor-5d-compressed-rsi-reversal
description: Use when computing the 5D Compressed RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed RSI Reversal

Use this Skill to compute `5日压缩RSI反转` / `5D Compressed RSI Reversal` from caller-provided OHLCV data.

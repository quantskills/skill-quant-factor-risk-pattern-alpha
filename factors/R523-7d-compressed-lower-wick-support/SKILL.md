---
name: quant-real-factor-7d-compressed-lower-wick-support
description: Use when computing the 7D Compressed Lower Wick Support factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Lower Wick Support

Use this Skill to compute `7日压缩下影线支撑` / `7D Compressed Lower Wick Support` from caller-provided OHLCV data.

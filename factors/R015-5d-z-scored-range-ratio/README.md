...
`5日标准化振幅占比` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `波动率` 类。

### 因子逻辑

```text
z(range_ratio, window=5)
```
...
- 可用行数: `195455`
- 覆盖率: `0.9925`
- 5日 Rank IC 均值: `0.003920`
- 5日 ICIR: `0.1611`
- 五分组 Q5-Q1 均值: `0.001691`
- Top 组换手: `0.3193`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Z-Scored Range Ratio` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volatility` family.
...
- Usable rows: `195455`
- Coverage: `0.9925`
- 5-day Rank IC mean: `0.003920`
- 5-day ICIR: `0.1611`
- Quintile Q5-Q1 mean: `0.001691`
- Top-quintile turnover: `0.3193`

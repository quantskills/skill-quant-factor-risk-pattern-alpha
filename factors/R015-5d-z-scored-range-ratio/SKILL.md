---
name: quant-real-factor-5d-z-scored-range-ratio
description: Use when computing the 5D Z-Scored Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Range Ratio

Use this Skill to compute `5日标准化振幅占比` / `5D Z-Scored Range Ratio` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-stability-scaled-stochastic-position
description: Use when computing the 10D Stability Scaled Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Stochastic Position

Use this Skill to compute `10日稳定度缩放随机区间位置` / `10D Stability Scaled Stochastic Position` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-volume-confirmed-stochastic-position
description: Use when computing the 10D Volume Confirmed Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Stochastic Position

Use this Skill to compute `10日量能确认随机区间位置` / `10D Volume Confirmed Stochastic Position` from caller-provided OHLCV data.

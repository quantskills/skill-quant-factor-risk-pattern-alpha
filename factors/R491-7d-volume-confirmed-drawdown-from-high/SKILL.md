---
name: quant-real-factor-7d-volume-confirmed-drawdown-from-high
description: Use when computing the 7D Volume Confirmed Drawdown From High factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日量能确认距高点回撤` / `7D Volume Confirmed Drawdown From High` from caller-provided OHLCV data.

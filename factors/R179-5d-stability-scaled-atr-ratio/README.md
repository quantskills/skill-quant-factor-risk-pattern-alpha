...
`5日稳定度缩放ATR占比` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `波动率` 类。

### 因子逻辑

```text
stability(atr_ratio, window=5)
```
...
`5D Stability Scaled ATR Ratio` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volatility` family.
...
- Usable rows: `195455`
- Coverage: `0.9925`
- 5-day Rank IC mean: `0.001508`
- 5-day ICIR: `0.0732`
- Quintile Q5-Q1 mean: `0.000678`
- Top-quintile turnover: `0.2050`

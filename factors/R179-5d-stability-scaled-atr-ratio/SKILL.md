---
name: quant-real-factor-5d-stability-scaled-atr-ratio
description: Use when computing the 5D Stability Scaled ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled ATR Ratio

Use this Skill to compute `5日稳定度缩放ATR占比` / `5D Stability Scaled ATR Ratio` from caller-provided OHLCV data.

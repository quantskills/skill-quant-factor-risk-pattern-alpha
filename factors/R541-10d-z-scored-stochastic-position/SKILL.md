---
name: quant-real-factor-10d-z-scored-stochastic-position
description: Use when computing the 10D Z-Scored Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Stochastic Position

Use this Skill to compute `10日标准化随机区间位置` / `10D Z-Scored Stochastic Position` from caller-provided OHLCV data.

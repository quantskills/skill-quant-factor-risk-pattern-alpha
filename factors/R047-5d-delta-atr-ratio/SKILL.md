---
name: quant-real-factor-5d-delta-atr-ratio
description: Use when computing the 5D Delta ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日变化ATR占比` / `5D Delta ATR Ratio` from caller-provided OHLCV data.

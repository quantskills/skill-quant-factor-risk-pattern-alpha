---
name: quant-real-factor-5d-volatility-scaled-rsi-reversal
description: Use when computing the 5D Volatility Scaled RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled RSI Reversal

Use this Skill to compute `5日波动缩放RSI反转` / `5D Volatility Scaled RSI Reversal` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-delta-intraday-return
description: Use when computing the 10D Delta Intraday Return factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Intraday Return

Use this Skill to compute `10日变化日内收益` / `10D Delta Intraday Return` from caller-provided OHLCV data.

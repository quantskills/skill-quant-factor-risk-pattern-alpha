---
name: quant-real-factor-7d-stability-scaled-lower-wick-support
description: Use when computing the 7D Stability Scaled Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Lower Wick Support

Use this Skill to compute `7日稳定度缩放下影线支撑` / `7D Stability Scaled Lower Wick Support` from caller-provided OHLCV data.

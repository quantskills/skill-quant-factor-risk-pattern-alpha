---
name: quant-real-factor-10d-compressed-stochastic-position
description: Use when computing the 10D Compressed Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Stochastic Position

Use this Skill to compute `10日压缩随机区间位置` / `10D Compressed Stochastic Position` from caller-provided OHLCV data.

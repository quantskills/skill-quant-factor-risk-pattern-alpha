---
name: quant-real-factor-10d-z-scored-range-ratio
description: Use when computing the 10D Z-Scored Range Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Range Ratio

Use this Skill to compute `10日标准化振幅占比` / `10D Z-Scored Range Ratio` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-delta-lower-wick-support
description: Use when computing the 5D Delta Lower Wick Support factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Lower Wick Support

Use this Skill to compute `5日变化下影线支撑` / `5D Delta Lower Wick Support` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-volatility-scaled-atr-ratio
description: Use when computing the 5D Volatility Scaled ATR Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled ATR Ratio

Use this Skill to compute `5日波动缩放ATR占比` / `5D Volatility Scaled ATR Ratio` from caller-provided OHLCV data.

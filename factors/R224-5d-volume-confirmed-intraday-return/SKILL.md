---
name: quant-real-factor-5d-volume-confirmed-intraday-return
description: Use when computing the 5D Volume Confirmed Intraday Return factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Intraday Return

Use this Skill to compute `5日量能确认日内收益` / `5D Volume Confirmed Intraday Return` from caller-provided OHLCV data.

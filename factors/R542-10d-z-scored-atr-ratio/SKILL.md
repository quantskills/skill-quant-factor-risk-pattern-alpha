---
name: quant-real-factor-10d-z-scored-atr-ratio
description: Use when computing the 10D Z-Scored ATR Ratio factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored ATR Ratio

Use this Skill to compute `10日标准化ATR占比` / `10D Z-Scored ATR Ratio` from caller-provided OHLCV data.

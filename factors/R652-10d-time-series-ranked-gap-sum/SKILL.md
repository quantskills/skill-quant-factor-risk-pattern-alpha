---
name: quant-real-factor-10d-time-series-ranked-gap-sum
description: Use when computing the 10D Time-Series Ranked Gap Sum factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Gap Sum

Use this Skill to compute `10日时序排名缺口累积` / `10D Time-Series Ranked Gap Sum` from caller-provided OHLCV data.

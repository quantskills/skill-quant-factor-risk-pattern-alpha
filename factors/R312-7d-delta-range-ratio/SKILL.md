---
name: quant-real-factor-7d-delta-range-ratio
description: Use when computing the 7D Delta Range Ratio factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Range Ratio

Use this Skill to compute `7日变化振幅占比` / `7D Delta Range Ratio` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-time-series-ranked-stochastic-position
description: Use when computing the 10D Time-Series Ranked Stochastic Position factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Stochastic Position

Use this Skill to compute `10日时序排名随机区间位置` / `10D Time-Series Ranked Stochastic Position` from caller-provided OHLCV data.

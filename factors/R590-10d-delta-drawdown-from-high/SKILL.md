---
name: quant-real-factor-10d-delta-drawdown-from-high
description: Use when computing the 10D Delta Drawdown From High factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Drawdown From High

Use this Skill to compute `10日变化距高点回撤` / `10D Delta Drawdown From High` from caller-provided OHLCV data.

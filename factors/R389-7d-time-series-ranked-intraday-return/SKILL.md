---
name: quant-real-factor-7d-time-series-ranked-intraday-return
description: Use when computing the 7D Time-Series Ranked Intraday Return factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:

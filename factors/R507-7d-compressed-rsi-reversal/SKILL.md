---
name: quant-real-factor-7d-compressed-rsi-reversal
description: Use when computing the 7D Compressed RSI Reversal factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed RSI Reversal

Use this Skill to compute `7日压缩RSI反转` / `7D Compressed RSI Reversal` from caller-provided OHLCV data.

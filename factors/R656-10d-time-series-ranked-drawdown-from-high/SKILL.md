---
name: quant-real-factor-10d-time-series-ranked-drawdown-from-high
description: Use when computing the 10D Time-Series Ranked Drawdown From High factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Drawdown From High

Use this Skill to compute `10日时序排名距高点回撤` / `10D Time-Series Ranked Drawdown From High` from caller-provided OHLCV data.

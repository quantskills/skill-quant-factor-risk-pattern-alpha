---
name: quant-real-factor-10d-z-scored-drawdown-from-high
description: Use when computing the 10D Z-Scored Drawdown From High factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Drawdown From High

Use this Skill to compute `10日标准化距高点回撤` / `10D Z-Scored Drawdown From High` from caller-provided OHLCV data.

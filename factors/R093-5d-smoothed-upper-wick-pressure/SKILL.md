---
name: quant-real-factor-5d-smoothed-upper-wick-pressure
description: Use when computing the 5D Smoothed Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Upper Wick Pressure

Use this Skill to compute `5日平滑上影线压力` / `5D Smoothed Upper Wick Pressure` from caller-provided OHLCV data.

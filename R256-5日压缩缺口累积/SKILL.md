---
name: quant-real-factor-5d-compressed-gap-sum
description: Use when computing the 5D Compressed Gap Sum factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Gap Sum

Use this Skill to compute `5日压缩缺口累积` / `5D Compressed Gap Sum` from caller-provided OHLCV data.

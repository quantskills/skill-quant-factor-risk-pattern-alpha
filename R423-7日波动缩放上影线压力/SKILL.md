---
name: quant-real-factor-7d-volatility-scaled-upper-wick-pressure
description: Use when computing the 7D Volatility Scaled Upper Wick Pressure factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled Upper Wick Pressure

Use this Skill to compute `7日波动缩放上影线压力` / `7D Volatility Scaled Upper Wick Pressure` from caller-provided OHLCV data.

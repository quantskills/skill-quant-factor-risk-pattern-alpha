---
name: quant-real-factor-5d-delta-rsi-reversal
description: Use when computing the 5D Delta RSI Reversal factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta RSI Reversal

Use this Skill to compute `5日变化RSI反转` / `5D Delta RSI Reversal` from caller-provided OHLCV data.
